...
const SITES = [
  ...
  },
  {
    ...
    domain: 'realtor.com',
    description: 'Portal internacional de realtor.com. 38 terrenos en venta en Mazatlán con precio en MXN y USD, superficie (m²) e imágenes vía HTTP directo — sin anti-bot, muy rápido.',
    totalProperties: 38,
  },
  {
    id: 'buscatucasa',
    name: 'BuscaTuCasa',
    domain: 'buscatucasa.mx',
    description: 'Inmobiliaria directa de Mazatlán (WordPress RealHomes). 11 terrenos con datos completos (precio, m², ubicación, coordenadas, descripción, galería) vía REST API — sin anti-bot, muy rápido.',
    totalProperties: 11,
  },
  {
    id: 'doorvel',
    name: 'Doorvel',
    domain: 'doorvel.com',
    description: 'Plataforma inmobiliaria (Next.js). ~131 terrenos en venta en Mazatlán con datos completos (precio MXN/USD, m², ubicación, coordenadas, descripción, galería de fotos) vía su API pública — sin anti-bot, muy rápido.',
    totalProperties: 131,
  },
  {
    id: 'palmaz',
    ...
    description: 'Inmobiliaria directa de Mazatlán (plataforma Wasi). 12 terrenos con precio, descripción rica, coordenadas e imagen vía HTTP directo — sin anti-bot.',
    totalProperties: 12,
  },
  {
    id: 'propiedades_com',
  ...
  },
  {
    ...
    domain: 'inmuebles.mercadolibre.com.mx',
    description: 'Marketplace inmobiliario. Protegido por DataDome + verificación de cuenta (exige sesión logueada). Bloquea scrapers incluso con navegador real. Descartado. (Agrega anuncios de otros portales que ya scrapeamos.)',
    totalProperties: null,
    disabled: true,
    blocked: true,
  },
  {
    id: 'properstar',
    name: 'Properstar',
    domain: 'properstar.mx',
    description: 'Agregador internacional. Responde 429 ("Service unavailable") de entrada a scrapers e IPs de datacenter — bloquea incluso con navegador real. Descartado. (Agrega anuncios de otros portales que ya scrapeamos.)',
    totalProperties: null,
    disabled: true,
    blocked: true,
  },
